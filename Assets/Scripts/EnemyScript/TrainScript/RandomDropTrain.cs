...
public class RandomDropTrain : MonoBehaviour
{
    ...
    {
        Debug.Log("返却対象: " + RightSideDropObject);
        Debug.Log("activeSelf: " + RightSideDropObject.activeSelf);
        Debug.Log("返却対象: " + LeftSideDropObject);
        Debug.Log("activeSelf: " + LeftSideDropObject.activeSelf);
